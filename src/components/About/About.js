  ...
  return (
    <div>
      <Container>
        ...
        <Row>
          <Col xs={12} md={6}>
            <div className="about_mes">
              <p>
                Hello,My name is Anil kumar Nayak.I'm a Full-stack Web
                Developer.
              </p>

              <p>
                Strong information technology professional with a B.Tech-focused
                in Mechanical Engineering from Bhubaneswar Engineering College
                with strong fundamental skills. I specialize in Coding,
                frontend, backend, Public Relations, Leadership qualities, and
                Interpersonal Skills. I am passionate about learning new
                technologies and finding my way to make a difference in society.
                I have always been interested in the world of coding and the
                things that are involved in it. This passion for coding drives
                me to explore the fields of IT sectors and work for an
                organization that makes the real world better.
              </p>
            </div>
          </Col>
          <Col xs={12} md={6}></Col>
        ...
        <Row className="about_direction">
          <Col xs={12} md={6}>
            <div className="about_svg_logo">
              <svg
