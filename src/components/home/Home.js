...
import pdf from "./Anil_Kumar_Nayak_FullStack_Resume.pdf";
  ...
  return (
    <div>
      <Container>
        ...
        <Row>
          <h1 className="home_heading_2" style={{ marginBottom: "30px" }}>
            What I Do?
          </h1>
        </Row>
        <Row className="direction">
          <Col xs={12} md={6}>
            <div className="svg_logo_1">
              <svg
              ...
              >
                ...
                <circle
                  ...
                  opacity="0.3"
                ></circle>
                <circle cx="350" cy="291.01368" r="25" fill="#0E6BA8"></circle>
                <circle
                  cx="804.375"
                  cy="157.1852"
                  r="54"
                ...
                <circle
                  ...
                  opacity="0.3"
                ></circle>
                <circle cx="814" cy="532.01368" r="25" fill="#0E6BA8"></circle>
                <rect
                  x="141.09287"
                  y="215.02041"
                  width="22.24232"
            ...
            <div>
              ...
              <div style={{ marginTop: "10px" }}>
                <div className="ar_icon">
                  ...
                  />
                  <span className="mes_2">
                    Developing both the front-end and Back-end components of web
                    applications.
                  </span>
                </div>
                <div className="ar_icon">
                  ...
                  />
                  <span className="mes_2">
                    Creating responsive and interactive front-end interfaces
                ...
                <div className="ar_icon">
                  ...
                  />
                  <span className="mes_2">
                    Implementing server-side logic and database interactions to
                    ensure seamless data flow and efficient functionality.
                  </span>
                </div>
                <div className="ar_icon">
                  <FaHandPointRight
                  ...
                  />
                  <span className="mes_2">
                    Testing, debugging, and deploying applications, continuously
                    improving their performance and scalability.
                  </span>
                </div>
              </div>
            </div>
